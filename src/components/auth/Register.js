  ...
  return (
    <div className='auth-form'>
      ...
      <form className='form' onSubmit={register}>
        ...
        <label htmlFor='form-password'>Password</label>
        <input id='form-passwordVerify' type='password' value={formPasswordVerify} onChange={(e) => setFormPasswordVerify(e.target.value)} />

        <label htmlFor='form-img'>Avatar</label>
        <input className='btn-img' id='form-img' type='file' value={formImg} onChange={(e) => setFormImg(e.target.value)} />
